...
namespace FamilyFinance2.Forms.Transaction {
    ...
    public partial class TransactionDataSet : global::System.Data.DataSet {
        ...
        public partial class EnvelopeLineDataTable : global::System.Data.TypedTableBase<EnvelopeLineRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            public EnvelopeLineRow AddEnvelopeLineRow(int id, LineItemRow parentLineItemRowByFK_SubLine_lineID, EnvelopeRow parentEnvelopeRowByFK_SubLine_envelopeID, string description, decimal amount) {
        ...
        public partial class EnvelopeRow : global::System.Data.DataRow {
            ...
            public EnvelopeLineRow[] GetEnvelopeLineRows() {
                if ((this.Table.ChildRelations["FK_SubLine_envelopeID"] == null)) {
                    ...
                    return ((EnvelopeLineRow[])(base.GetChildRows(this.Table.ChildRelations["FK_SubLine_envelopeID"])));
                }
            }
        ...
        public partial class LineItemRow : global::System.Data.DataRow {
            ...
            public EnvelopeLineRow[] GetEnvelopeLineRows() {
                if ((this.Table.ChildRelations["FK_SubLine_lineID"] == null)) {
                    ...
                    return ((EnvelopeLineRow[])(base.GetChildRows(this.Table.ChildRelations["FK_SubLine_lineID"])));
                }
            }
        }
...
namespace FamilyFinance2.Forms.Transaction.TransactionDataSetTableAdapters {
    ...
    public partial class AccountTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [id], [name], [accountTypeID], [catagoryID], [closed], [creditDebit], [env" +
                "elopes], [endingBalance] FROM [Account]";
    ...
    public partial class EnvelopeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT [id], [name], [fullName], [parentEnvelope], [closed], [endingBalance] FROM" +
                " [Envelope]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
    ...
    public partial class EnvelopeLineTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = @"SELECT        EnvelopeLine.id, EnvelopeLine.lineItemID, EnvelopeLine.envelopeID, EnvelopeLine.description, EnvelopeLine.amount
FROM            EnvelopeLine INNER JOIN
                         LineItem ON EnvelopeLine.lineItemID = LineItem.id
WHERE        (LineItem.transactionID = @transID)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int FillByTransactionID(TransactionDataSet.EnvelopeLineDataTable dataTable, int transID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual TransactionDataSet.EnvelopeLineDataTable GetDataByTransactionID(int transID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(transID));
    ...
    public partial class LineItemTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [LineItem] ([id], [transactionID], [date], [lineTypeID], [accountID], [oppAccountID], [description], [confirmationNumber], [envelopeID], [complete], [amount], [creditDebit]) VALUES (@p1, @p2, @p3, @p4, @p5, @p6, @p7, @p8, @p9, @p10, @p11, @p12)";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@p1", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "id", global::System.Data.DataRowVersion.Current, null));
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlServerCe.SqlCeCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [LineItem] SET [id] = @p1, [transactionID] = @p2, [date] = @p3, [lineTypeID] = @p4, [accountID] = @p5, [oppAccountID] = @p6, [description] = @p7, [confirmationNumber] = @p8, [envelopeID] = @p9, [complete] = @p10, [amount] = @p11, [creditDebit] = @p12 WHERE (([id] = @p13))";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlServerCe.SqlCeParameter("@p1", global::System.Data.SqlDbType.Int, 0, global::System.Data.ParameterDirection.Input, true, 0, 0, "id", global::System.Data.DataRowVersion.Current, null));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int FillByTransactionID(TransactionDataSet.LineItemDataTable dataTable, int transID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(transID));
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual TransactionDataSet.LineItemDataTable GetDataByTransactionID(int transID) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            this.Adapter.SelectCommand.Parameters[0].Value = ((int)(transID));
